...
char p1writemessages[10] ="HELLO",p2writemessages[10] ="WORLD",readmessage[10];
returnstatus1 = pipe(pipe1fds);
...
write(pipe1fds[1],p1writemessages,sizeof(p1writemessages));
...
printf("IN CHILD PROCESS - WRITING TO PIPE 2 -  MESSAGE  2 %s\n",p2writemessages);
write(pipe2fds[1],p2writemessages,sizeof(p2writemessages));
}
return 0;
}
